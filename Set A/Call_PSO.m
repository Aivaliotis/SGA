...
params.nPop = 100;             % Particle Population Size (Swarm Size) / (Choose 0 for pure GA)
...
for i=1:params.exenum
    disp([num2str(study_case) ' PSO ' num2str(i)])
[PSO(i,study_case).GB,PSO(i,study_case).progress ]= SGA_2022(problem,params);
end
end